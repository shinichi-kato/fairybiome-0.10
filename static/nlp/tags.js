/* 似た概念をまとめてタグ化する辞書
 ...
 タグに変換される側の文字列は正規表現
*/
export let systemTags = {
  '{I}': ['私', 'ボク', '僕', '俺', 'わたし', 'あたし', 'ぼく', 'ボク',
    'オレ', 'おれ', '拙者', 'わたくし'],
  '{YOU}': ['キミ', 'きみ', '君ら', '君たち', '君達', 'あなた', '貴女',
    '貴男', 'お前', 'おまえ', '貴様', 'きさま', '君'],
  '{MY}': ['私の', 'ボクの', '僕の', '俺の', 'わたしの', 'あたしの', 'ぼくの', 'ボクの',
    'オレの', 'おれの', '拙者の', 'わたくしの'],
  '{YOUR}': ['キミの', 'きみの', '君らの', '君たちの', '君達の', 'あなたの', '貴女の',
    '貴男の', 'お前の', 'おまえの', '貴様の', 'きさまの', '君の']
};

export const ICITags = [
  ...
  ['問題', '課題'],
  ['さよなら', 'さようなら', 'バイバイ', 'またね'],
  ['綺麗','きれい','美しい','エレガント','美人','素敵','良い'],
  ['かっこいい','カッコいい','格好いい','格好良い','かっこ良い','ハンサム','たくましい','強そう'],
  ['賢い','頭いい','頭良い','スマート'],
